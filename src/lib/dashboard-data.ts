 ...
 * Returns the empty payload if there's no session or the queries fail — the UI
...
export async function getDashboardData(): Promise<DashboardPayload> {
  ...
  // Build a quick lookup so each application card can show its resume's ATS score.
